...
async function main() {
  ...
  const contractAddress = "0xD2Ab269dB10ae639d86f5eCfef48b330721F770B"; // Replace with the deployed contract address
  const contractAbi = [
  ...
  const signer = new ethers.Wallet("", provider); // Replace with your private key
